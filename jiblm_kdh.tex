...
\begin{flushleft}
\hspace{8.0mm}
% \rule{0.3\linewidth}{0.3mm} % DJH - remove for use with students
% \lettrine[lines=2]{D}{raft \rule[3pt]{10mm}{0.5pt} Draft \rule[3pt]{10mm}{0.5pt} Draft \rule[3pt]{10mm}{0.5pt} Draft} % DJH - remove for use with students
% \rule{0.3\linewidth}{0.3mm}  % DJH - remove for use with students
...
\def\maketitle{%
  \null
  \thispagestyle{empty}%
%  \timestamp %DJH - remove for use with students
  \authormasthead
  %\vfill
  \normalfont
  \vspace{2in}
...
%\lfoot{Hunter $<$ Morrow} \cfoot{} \rfoot{\emph{DRAFT -- DRAFT -- DRAFT}} %DJH - for jiblm
\lfoot{Hunter $<$ Morrow} \cfoot{} \rfoot{} %DJH - for students
