...
\item[Professor:] David J. Hunter, Ph.D.
 ...
 \item[Tentative Schedule:] We will try to conform to the following
  ...
  \begin{description}[itemsep=0pt, parsep=1pt, partopsep=-5pt]
      \item[Advanced Group Theory] \mbox{}
          \begin{itemize}[itemsep=0pt, parsep=1pt, partopsep=-5pt]
              \item Symmetry
              \item Group Actions
              \item Sylow Theory
          \end{itemize}
      \item[Field Theory]\mbox{}
          \begin{itemize}[itemsep=0pt, parsep=1pt, partopsep=-5pt]
              \item Fields and Extensions
              \item Algebraic Extensions
          \end{itemize}
      \item[Galois Theory]\mbox{}
           \begin{itemize}[itemsep=0pt, parsep=1pt, partopsep=-5pt]
              \item Isomorphisms of Fields
              \item Splitting Fields
              \item Separability and Perfect Fields
              \item The Galois Group
              \item The Fixed Field
              \item The Fundamental Theorem
              \item Solvability by Radicals
          \end{itemize}
     \item[Groups in Topology] (time permitting)
