...
This course presents an opportunity for you to grow in your ability to work by yourself. I strongly recommend that you spend time alone with the assigned problems before working with others. If you do work with others on an assignment, please include a note on your assignment indicating the names of those you worked with. And remember that \textbf{the work you hand in should represent your own understanding.} 
...
```{r echo=FALSE}
kbl(data.frame(x = c("Written Prework Assignments", "Typeset Final Drafts", "Exams (3)", "Final Exam"),
                 y = c("15%", "20%", "15% each", "20%")), col.names = NULL, booktabs = TRUE)
```
